...
namespace ImagineCup
{
    public partial class App : Application
    {
        ...
        public bool IsFromRoutePage;
        public AMap TempMap;
        public LatLng _latlng;
        public LatLng _CameraLatLng;
        public float _mapZoom;
        public float _bearing;
        public float _tile;
        public AMapMarker _locationMarker;
        public AMapCircle _circle;
        public  bool _cameraIsNew;
        public bool _isNew;
        #endregion
        ...
        private void Application_Activated(object sender, ActivatedEventArgs e)
        {
            ...
            //{
            //    TempMap = PhoneApplicationService.Current.State["map"] as AMap;
            //    _latlng = PhoneApplicationService.Current.State["latlng"] as LatLng;
            //    _bearing = (float)PhoneApplicationService.Current.State["bearing"];
            //    _tile = (float)PhoneApplicationService.Current.State["tile"];
            //    _circle = PhoneApplicationService.Current.State["circle"] as AMapCircle;
            //    _locationMarker = PhoneApplicationService.Current.State["locationMarker"] as AMapMarker;
            //    _CameraLatLng = PhoneApplicationService.Current.State["cameraLatLng"] as LatLng;
            //    _mapZoom = (float)PhoneApplicationService.Current.State["mapZoom"];
            //    _cameraIsNew = (bool)PhoneApplicationService.Current.State["cameraIsNew"];
            //}
        ...
        private void Application_Deactivated(object sender, DeactivatedEventArgs e)
        {
            //if (TempMap != null)
            //{
            //    PhoneApplicationService.Current.State["map"] = TempMap;
            //    PhoneApplicationService.Current.State["latlng"] = _latlng;
            //    PhoneApplicationService.Current.State["bearing"] = _bearing;
            //    PhoneApplicationService.Current.State["tile"] = _tile;
            //    PhoneApplicationService.Current.State["locationMarker"] = _locationMarker;
            //    PhoneApplicationService.Current.State["circle"] = _circle;
            //    PhoneApplicationService.Current.State["cameraLatLng"] = _CameraLatLng;
            //    PhoneApplicationService.Current.State["mapZoom"] = _mapZoom;
            //    PhoneApplicationService.Current.State["cameraIsNew"] = _cameraIsNew;
            //}
        }
